...
public class DB_PARTICIPANT {
    ...
    public DB_PARTICIPANT(Connection conn) {
        ...
        try {
            ...
            ps_update = conn.prepareStatement("update participant set nom=?, age=? where idp=? Cascade");
            ps_delete = conn.prepareStatement("delete from participant where idp=? cascade");
