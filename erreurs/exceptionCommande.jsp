...
<table border="1">
    <tr>
        ...
        <td><%=request.getParameter("cmd")%>
        </td>
    </tr>
    <tr>
        <th>Classe de la commande</th>
        <td><%=request.getAttribute("classe")%>
        </td>
    </tr>
    <tr>
        <th>Classe d'exception</th>
        <td><%=request.getAttribute("classeException")%>
        </td>
    </tr>
    <tr>
        <th>Message d'exception</th>
        <td><%=request.getAttribute("exception")%>
        </td>
    </tr>
</table>
